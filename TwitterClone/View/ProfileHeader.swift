...
class ProfileHeader: UICollectionReusableView {
    ...
    private let bioLabel: UILabel = {
        ...
        label.text = "This is a user bio that will span more than one loin "
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        let userDetailStack = UIStackView(arrangedSubviews: [usernameLabel,fullnameLabel,bioLabel])
    ...
    @objc func handleDismissal() {
        delegate?.handelDismissal()
    }
    
    @objc func handleEditProfileFollow() {
        print("Debug editProilFollw")
    }
